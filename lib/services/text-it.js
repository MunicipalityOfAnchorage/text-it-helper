...
/**
 * Fetch contact by URN.
 *
 * @param {String}
 * @return {Promise}
 */
module.exports.getContactByUrn = (urn) => {
  return get('contacts', { urn })
    .then(res => res.body.results[0]);
};
 ...
 * @return {Promise}
 */
module.exports.createFlowStart = (flowId, contactId) => {
  return post('flow_starts', { flow: flowId, contacts: [contactId] })
    .then(res => res.body);
};
